...
// В «дикой природе» номер записи будет появляться во время
...
// В приложении, развернутом в производственной среде,
// дату будет присваивать проверенный и доверенный сервер,
...
export const register = (newRecord: Readonly<Omit<LogRecord, 'id' | 'date'>>): void => {
  logFramework({
    ...newRecord,
    id: nextIdentity(),
    date: getDate(),
