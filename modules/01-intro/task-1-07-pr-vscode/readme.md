...
1. Далее найдите и раскоментарьте строку `"module":`, измените ее, чтобы она стала `"module": "ES2020"`
1. Далее найдите и раскоментарьте строку `"outDir":`, измените ее, чтобы она стала `"outDir": "./js"`
...
В контексте разработки TypeScript приложений файлы исходных текстов хранятся в папке src и имеют расширения .ts, .tsx. Компилятор создает производные файлы .js. В настройках `tsconfig` мы их направили в папку js. Эту папку не следует включать в репо.
...
а так же что вы собираетесь использовать typescript. Некоторые правила линтера стоит переключить на их TypeScript-овые аналоги вот таким образом
